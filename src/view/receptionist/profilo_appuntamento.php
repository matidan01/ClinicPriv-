...
$get_appuntamento = "SELECT appuntamento.idPrestazione, appuntamento.codicePrestazione, 
                ...
                WHERE DATE(appuntamento.idPrestazione) = ?
...
<div class="container py-5">
    ...
    if ($result && mysqli_num_rows($result) > 0) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modificaModalLabel">Modifica Appuntamento</h5>
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modificaModal">Modifica</button>
