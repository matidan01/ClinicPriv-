...
--
-- Host: 127.0.0.1
-- Creato il: Lug 16, 2024 alle 18:14
...
(3, 'Siringhe sterili', 200, 1, 2),
(4, 'Suture', 250, 3, 3),
(5, 'Disinfettante', 100, 5, 2),
(6, 'Pinze chirurgiche', 50, 10, 1),
(7, 'Forbici chirurgiche', 60, 12, 0),
(8, 'Bisturi', 100, 8, 0),
(9, 'Sacco di ghiaccio', 150, 2, 1),
(10, 'Elettrodi ECG', 200, 1, 1),
(11, 'Fiale di adrenalina', 30, 15, 2),
...
(1, 'Mario', 'Rossi', 'RSSMRA80A01H501Z', 'mario.rossi@example.com', '1980-01-01', 'Roma', 2147483647, 'Nessuna nota'),
...
(1, 51, '2024-08-20', '2024-08-24', 'R001', '08:00:00.0', 107),
...
--
ALTER TABLE `materiale`
  MODIFY `idMateriale` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `terapia`
  MODIFY `idTerapia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
